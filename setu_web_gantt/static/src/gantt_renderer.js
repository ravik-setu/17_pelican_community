...
export class GanttRenderer extends Component {
    ...
    static template = "setu_web_gantt.GanttRenderer";
    static connectorCreatorTemplate = "setu_web_gantt.GanttRenderer.ConnectorCreator";
    static headerTemplate = "setu_web_gantt.GanttRenderer.Header";
    static pillTemplate = "setu_web_gantt.GanttRenderer.Pill";
    static rowContentTemplate = "setu_web_gantt.GanttRenderer.RowContent";
    static rowHeaderTemplate = "setu_web_gantt.GanttRenderer.RowHeader";
    static totalRowTemplate = "setu_web_gantt.GanttRenderer.TotalRow";
