...
class PickingType(models.Model):
    ...
    def action_mrp_overview(self):
        ...
        if routing_count == 1:
            return self.env['ir.actions.actions']._for_xml_id('setu_mrp_workorder.action_mrp_display')
        action = self.env['ir.actions.actions']._for_xml_id('setu_mrp_workorder.mrp_stock_picking_type_action')
