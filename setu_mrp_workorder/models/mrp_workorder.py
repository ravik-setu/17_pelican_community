...
class MrpProductionWorkcenterLine(models.Model):
    ...
    def action_back(self):
        ...
        if self.env.context.get('from_manufacturing_order'):
            ...
            action = self.env["ir.actions.actions"]._for_xml_id("setu_mrp_workorder.mrp_workorder_action_tablet")
    ...
    def action_menu(self):
        return {
            ...
            'views': [[self.env.ref('setu_mrp_workorder.mrp_workorder_view_form_tablet_menu').id, 'form']],
            'name': _('Menu'),
            'target': 'new',
            'res_id': self.id,
        }
    ...
    def action_propose_change(self, change_type, check_id):
        ...
        return {
            ...
            'views': [[self.env.ref('setu_mrp_workorder.view_propose_change_wizard').id, 'form']],
    ...
    def action_add_step(self):
        ...
        return {
            ...
            'views': [[self.env.ref('setu_mrp_workorder.add_quality_check_from_tablet').id, 'form']],
            'name': _('Add a Step'),
            'target': 'new',
            'context': {
    ...
    def action_open_mes(self):
        action = self.env['ir.actions.actions']._for_xml_id('setu_mrp_workorder.action_mrp_display')
        action['context'] = {
    ...
    def open_tablet_view(self):
        ...
        if self._should_start():
            self.button_start()
        action = self.env["ir.actions.actions"]._for_xml_id("setu_mrp_workorder.tablet_client_action")
    ...
    def get_workorder_data(self):
        ...
        data = {
            ...
            'views': {
                'workorder': self.env.ref('setu_mrp_workorder.mrp_workorder_view_form_tablet').id,
                'check': self.env.ref('setu_mrp_workorder.quality_check_view_form_tablet').id,
            },
        }
    ...
    def action_mrp_workorder_dependencies(self, action_name):
        ...
        ref = 'setu_mrp_workorder.workcenter_line_gantt_production_dependencies' if action_name == 'production' else 'mrp_workorder.mrp_workorder_view_gantt_dependencies'
