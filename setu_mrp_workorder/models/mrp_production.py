...
class MrpProduction(models.Model):
    ...
    def action_add_byproduct(self):
        ...
        return {
            ...
            'res_model': 'setu_mrp_workorder.additional.product',
            'views': [[self.env.ref('setu_mrp_workorder.view_mrp_workorder_additional_product_wizard').id, 'form']],
    ...
    def action_add_workorder(self):
        return {
            ...
            'views': [[self.env.ref('setu_mrp_workorder.view_mrp_production_additional_workorder_wizard').id, 'form']],
    ...
    def action_load_samples(self):
        ...
        if self.user_has_groups('mrp.group_mrp_routings'):
            ...
            quality_points = [{'xml_id': xmlid, 'noupdate': True, 'values': {
                ...
                (
                    'setu_mrp_workorder.quality_point_register_serial_production',
                    'setu_mrp_workorder.test_type_register_production',
                ...
                (
                    'setu_mrp_workorder.quality_point_component_registration',
                    'setu_mrp_workorder.test_type_register_consumed_materials',
                ...
                (
                    'setu_mrp_workorder.quality_point_instructions',
                ...
                (
                    'setu_mrp_workorder.quality_point_component_registration_2',
                    'setu_mrp_workorder.test_type_register_consumed_materials',
                ...
                (
                    'setu_mrp_workorder.quality_point_register_production',
                    'quality.test_type_instructions',
                ...
                (
                    'setu_mrp_workorder.quality_point_print_labels',
                    'setu_mrp_workorder.test_type_print_label',
                    None,
                    'Print Labels',
                    0,
                    90,
