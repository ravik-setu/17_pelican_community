...
import { MrpDisplay } from "@setu_mrp_workorder/mrp_display/mrp_display";
import { Component, onWillStart, useSubEnv } from "@odoo/owl";
import { MrpDisplaySearchModel } from "@setu_mrp_workorder/mrp_display/search_model";

// from record.js
const defaultActiveField = { attrs: {}, options: {}, domain: "[]", string: "" };

export class MrpDisplayAction extends Component {
    static template = "setu_mrp_workorder.MrpDisplayAction";
    ...
    setup() {
        ...
        useSubEnv({
            localStorageName: `setu_mrp_workorder.db_${this.userService.db.name}.user_${this.userService.userId}.picking_type_${pickingTypeId}`,
        });
        onWillStart(async () => {
