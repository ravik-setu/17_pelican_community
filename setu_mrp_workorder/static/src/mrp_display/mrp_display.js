...
import { ControlPanelButtons } from "@setu_mrp_workorder/mrp_display/control_panel";
import { MrpDisplayRecord } from "@setu_mrp_workorder/mrp_display/mrp_display_record";
import { MrpWorkcenterDialog } from "./dialog/mrp_workcenter_dialog";
import { makeActiveField } from "@web/model/relational_model/utils";
import { MrpDisplayEmployeesPanel } from "@setu_mrp_workorder/mrp_display/employees_panel";
import { SelectionPopup } from "@setu_mrp_workorder/components/popup";
import { useConnectedEmployee } from "@setu_mrp_workorder/mrp_display/hooks/employee_hooks";
import { MrpDisplaySearchBar } from "@setu_mrp_workorder/mrp_display/search_bar";
...
export class MrpDisplay extends Component {
    static template = "setu_mrp_workorder.MrpDisplay";
    static components = {
        Layout,
        ControlPanelButtons,
        MrpDisplayRecord,
    ...
    setup() {
        ...
        this.state = useState({
            ...
            showEmployeesPanel: localStorage.getItem("setu_mrp_workorder.show_employees") === "true",
...
//    }
    ...
    toggleEmployeesPanel() {
        ...
        localStorage.setItem("setu_mrp_workorder.show_employees", String(this.state.showEmployeesPanel));
    }
