...
class PackageWeightWizard(models.TransientModel):
    ...
    def do_weight_and_update_in_package(self):
        self.package_id.raise_error_if_put_in_pack_does_not_contain_valid_quantity()
