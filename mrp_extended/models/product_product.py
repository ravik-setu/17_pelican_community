...
class ProductProduct(models.Model):
    ...
    destination_location_id = fields.Many2one('stock.location', 'Default Destination Location',
                                              related="product_tmpl_id.destination_location_id", readonly=False, store=True)
    show_qty_in_pcs = fields.Boolean(string="Show Quantity in PCS", related="product_tmpl_id.show_qty_in_pcs", readonly=False,
                                     store=True)
    ...
    is_raw_material = fields.Boolean(string="Is RawMaterial?", related='product_tmpl_id.is_raw_material', readonly=False, store=True)
    production_cost = fields.Float(string='Production Cost', related='product_tmpl_id.production_cost')
